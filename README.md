...
This direct-only branch records `no-pathfinding`, terrain safety samples, target ranking/visibility/player overlap, excluded action predicates and blueprint/supply filtering. The dashboard retains atomic execution and its 6,000-decision cap. Traces describe loaded observations and executed primitives rather than a full world snapshot.
