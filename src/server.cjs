...
archive=createArchive({directory:archiveDirectory,metadata:{botUsername,nodeVersion:process.version,controlMode:process.env.CONTROL_MODE==='direct'?'direct':'highlevel'}});
